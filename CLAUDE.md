...
- **AI Integration**: Multi-provider (OpenAI, AWS Bedrock)
- **Real-time**: Laravel Stream package for SSE streaming

### AI Providers
- **OpenAI**: GPT models with native streaming support
- **AWS Bedrock**: Claude models with custom binary stream parser (see [AWS_BEDROCK_STREAMING.md](docs/AWS_BEDROCK_STREAMING.md))
